...
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "astathon")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "astathon")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "astathon")
OWNER_NAME = getenv("OWNER_NAME", "astathon") 
DEV_NAME = getenv("DEV_NAME", "astathon")
